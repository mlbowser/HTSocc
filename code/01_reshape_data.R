...
out_file <- paste0("../documents/", format(Sys.time(), format="%Y-%m-%d-%H%M"), "_data_summaries.md")
...
image_file <- paste0("../documents/images/", format(Sys.time(), format="%Y-%m-%d-%H%M"), "_observations_vs_julian_day.png")
width <- 600
